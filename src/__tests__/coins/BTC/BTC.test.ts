import { regtestUtils } from './../../../utils/regtest';
...
describe("coin.BTC", () => {
  ...
  it("should generate the multiSign address", async () => {
    const myKeys = [
      publicKey,
      publicKeyOne,
    ];

    const address = xtn.generateMultiSignAddress(myKeys, 2);

    expect(address).toBe('2N8rqpUpbyJMtSXK6obH5GVufZ5rwE9fi5V');
  })

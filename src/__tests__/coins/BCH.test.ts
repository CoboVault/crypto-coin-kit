...
const txData = {
    inputs: [{
        ...
        index: 0,
        value: 805000,
        pubkey:'02c1b6f5e4917cbc628d914e2f1155e4195504ab3bfa58e4a8d367896c9d8016f8'
    }],
    outputs: [{
...
describe("coin.BCH", () => {
    ...
    it("should generate correct address", () => {
        expect(bch.generateAddress(publicKey,AddressType.P2PKH, AddressFormat.CASH)).toBe(
            "bitcoincash:qpfs2gcfwg322segkj4h30du4vtjyvsxtq6msk90a5"
        );
        expect(bch.generateAddress(publicKey)).toBe(
            "18ZyEqa4ioSiTztN5zHRNoQCr5ZYtMNTjJ"
        );
        expect(bch.generateAddress(publicKey,AddressType.P2PKH, AddressFormat.BITPAY)).toBe(
            "CQ2rosv8brRFN8nnmjcLxK2EUCmxrY8gJf"
        );
    });
    ...
    it("should valid a address", () => {
        ...
        const validResult1 = bch.isAddressValid("bitcoincash:qr5ulyf3m8qz5wsz6frtks5hk4sxcm9jlyqnpsdfkj");
        expect(validResult1).toBe(true);
        const failResult2 = bch.isAddressValid("bitcoincash:qr5ulyf3m8qz5wsz6frtks5hk4sxcm9jlyqnpsdfk");
    ...
    it('should signMessage',   () => {
        ...
        expect(message).toEqual("f1878d7e14434a1514566f184a64deb9534f6491a8bbf72d921ec02834714fce56127cf12942fe5e4b44cfac68003d846095b8fd112c4a6b99d60b8fd70bbfa3");
    });

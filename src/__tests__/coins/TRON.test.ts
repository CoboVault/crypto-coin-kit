...
describe("coin.TRON", () => {
    ...
    it('should generate valid address', () => {
        expect(tron.isAddressValid('TTiYGxb7YNfUQJAnLFMd1pvmoywM7PxiG2')).toBe(true);
        expect(tron.isAddressValid('TTiYGxb7YNfUQJAnLFMd1pvmoywM7PxiGH')).toBe(false);
        expect(tron.isAddressValid('3EwY1PaQ5fB4M4nvWRYgUn2LNmokeJ36Pj')).toBe(false)
    });
    ...
    it('should generate signed TRC20 token', async () => {
        const tx = await tron.generateTransaction(txDataTRC20, signWithPrivateKey('986e593a779463e5d15fba95939f22d48736ccac90d4d451942cdc1047757f06'));
    ...
    it('should sign message', async () => {
        expect(await tron.signMessage("hello", signWithPrivateKey(privKey)))

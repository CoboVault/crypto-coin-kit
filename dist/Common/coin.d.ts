...
export interface Coin extends BaseCoin {
    generateTransaction: (txData: any, keyProvider: KeyProvider, options?: any) => Promise<GenerateTransactionResult>;
...
export interface UtxoCoin extends BaseCoin {
    generateTransaction: (txData: any, keyProviders: KeyProvider[], options?: any) => Promise<GenerateTransactionResult>;
    generateTransactionSync: (txData: any, keyProviders: KeyProviderSync[], options?: any) => GenerateTransactionResult;

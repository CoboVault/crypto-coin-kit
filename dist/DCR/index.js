...
var DCR = /** @class */ (function () {
    function DCR(network) {
        var _this = this;
        ...
        this.generateTransaction = function (txData, signer, _a) { return __awaiter(_this, void 0, void 0, function () {
            var inputs, changeAddress, to, fee, amount, transaction;
            var _b = _a.disableLargeFees, disableLargeFees = _b === void 0 ? true : _b, options = __rest(_a, ["disableLargeFees"]);
        ...
        this.generateTransactionSync = function (txData, signer, _a) {
            var _b = _a.disableLargeFees, disableLargeFees = _b === void 0 ? true : _b, options = __rest(_a, ["disableLargeFees"]);
            var inputs = txData.inputs, changeAddress = txData.changeAddress, to = txData.to, fee = txData.fee, amount = txData.amount;
            var transaction = new dcr_core_1.Transaction()
                .from(formatInput_1.default(inputs))
                .to(to, amount)
                .fee(fee)
                .change(changeAddress);
            return processTransactionSync_1.default(transaction, signer.sign, options.signerPubkey, { disableLargeFees: disableLargeFees });
        };
        /**
        ...
        this.getSignMessageHex = function (message) {
            var MAGIC_BYTES = Buffer.from("\x16Decred Signed Message:\n", "utf-8");
